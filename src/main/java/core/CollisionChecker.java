    ...
    public void checkTile(Entity entity) {
        ...
        switch (entity.getDirection()) {
            case UP: {
                ...
                tile1 = gamepanel.getTileManager().getMap()[eLeftCol][eTopRow];
                tile2 = gamepanel.getTileManager().getMap()[eRightCol][eTopRow];
            ...
            case DOWN: {
                ...
                tile1 = gamepanel.getTileManager().getMap()[eLeftCol][eBottomRow];
                tile2 = gamepanel.getTileManager().getMap()[eRightCol][eBottomRow];
                if (!gamepanel.getTileManager().getTileByIndex(tile1).isWalkable() ||
                        !gamepanel.getTileManager().getTileByIndex(tile2).isWalkable()) {
                    entity.setCollisionHappening(true);
                }
            ...
            case RIGHT: {
                ...
                tile1 = gamepanel.getTileManager().getMap()[eRightCol][eTopRow];
                tile2 = gamepanel.getTileManager().getMap()[eRightCol][eBottomRow];
                if (!gamepanel.getTileManager().getTileByIndex(tile1).isWalkable() ||
                        !gamepanel.getTileManager().getTileByIndex(tile2).isWalkable()) {
                    entity.setCollisionHappening(true);
            ...
            case LEFT: {
                ...
                tile1 = gamepanel.getTileManager().getMap()[eLeftCol][eTopRow];
                tile2 = gamepanel.getTileManager().getMap()[eLeftCol][eBottomRow];
                if (!gamepanel.getTileManager().getTileByIndex(tile1).isWalkable() ||
                        !gamepanel.getTileManager().getTileByIndex(tile2).isWalkable()) {
                    entity.setCollisionHappening(true);
                }
